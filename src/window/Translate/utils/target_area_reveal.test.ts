...
describe('createTargetAreaReveal', () => {
    ...
    it('lets a failure that lands after a streamed chunk leave the open Target Area alone', () => {
        const { setHide, reveal } = revealSpy();
